      ...
      >
        ...
        <div className="screenshot-grid">
          ...
          <div className="screenshot-card">
            <img src="/screenshots/getstartedeasily.png" alt="Homepage" />
          ...
          <div className="screenshot-card">
            <img src="/screenshots/signinorcreate.png" alt="Sign In/Sign Up" />
            <div className="screenshot-caption">
          ...
          <div className="screenshot-card">
           <img src="/screenshots/joinameeting.png" alt="Start or Join Meeting" />
            <div className="screenshot-caption">
          ...
          <div className="screenshot-card">
            <img src="/screenshots/stepstojoin.png" alt="Steps to Join" />
            <div className="screenshot-caption">
              <h4>Steps to Join</h4>
          ...
          <div className="screenshot-card">
            <img src="/screenshots/youarenowinthemeeting.png" alt="You're Now in the Meeting" />
            <div className="screenshot-caption">
          ...
          <div className="screenshot-card">
            <img src="/screenshots/usemeetingtools.png" alt="Use Meeting Tools" />
            <div className="screenshot-caption">
